...
def parse(fn):
    ...
    if os.path.exists(cache_file):
        ...
        simple_id = ~CaselessKeyword("derive") + ~CaselessKeyword("binary") + ~CaselessKeyword("array") + ~CaselessKeyword("abs") + ~CaselessKeyword("abstract") + ~CaselessKeyword("hibound") + ~CaselessKeyword("acos") + ~CaselessKeyword("atan") + ~CaselessKeyword("andor") + ~CaselessKeyword("end_alias") + ~CaselessKeyword("aggregate") + ~CaselessKeyword("end_function") + ~CaselessKeyword("exists") + ~CaselessKeyword("begin") + ~CaselessKeyword("bag") + ~CaselessKeyword("and") + ~CaselessKeyword("false") + ~CaselessKeyword("alias") + ~CaselessKeyword("case") + ~CaselessKeyword("skip") + ~CaselessKeyword("for") + ~CaselessKeyword("blength") + ~CaselessKeyword("asin") + ~CaselessKeyword("as") + ~CaselessKeyword("list") + ~CaselessKeyword("end_type") + ~CaselessKeyword("hiindex") + ~CaselessKeyword("function") + ~CaselessKeyword("fixed") + ~CaselessKeyword("tan") + ~CaselessKeyword("integer") + ~CaselessKeyword("query") + ~CaselessKeyword("generic") + ~CaselessKeyword("log10") + ~CaselessKeyword("odd") + ~CaselessKeyword("mod") + ~CaselessKeyword("loindex") + ~CaselessKeyword("optional") + ~CaselessKeyword("if") + ~CaselessKeyword("set") + ~CaselessKeyword("insert") + ~CaselessKeyword("subtype_constraint") + ~CaselessKeyword("like") + ~CaselessKeyword("inverse") + ~CaselessKeyword("log2") + ~CaselessKeyword("lobound") + ~CaselessKeyword("log") + ~CaselessKeyword("rolesof") + ~CaselessKeyword("nvl") + ~CaselessKeyword("self") + ~CaselessKeyword("local") + ~CaselessKeyword("or") + ~CaselessKeyword("number") + ~CaselessKeyword("schema") + ~CaselessKeyword("value_in") + ~CaselessKeyword("logical") + ~CaselessKeyword("while") + ~CaselessKeyword("not") + ~CaselessKeyword("real") + ~CaselessKeyword("of") + ~CaselessKeyword("then") + ~CaselessKeyword("pi") + ~CaselessKeyword("until") + ~CaselessKeyword("otherwise") + ~CaselessKeyword("repeat") + ~CaselessKeyword("oneof") + ~CaselessKeyword("sizeof") + ~CaselessKeyword("reference") + ~CaselessKeyword("sin") + ~CaselessKeyword("rule") + ~CaselessKeyword("return") + ~CaselessKeyword("procedure") + ~CaselessKeyword("renamed") + ~CaselessKeyword("subtype") + ~CaselessKeyword("remove") + ~CaselessKeyword("type") + ~CaselessKeyword("select") + ~CaselessKeyword("end_constant") + ~CaselessKeyword("sqrt") + ~CaselessKeyword("boolean") + ~CaselessKeyword("format") + ~CaselessKeyword("supertype") + ~CaselessKeyword("end_schema") + ~CaselessKeyword("else") + ~CaselessKeyword("based_on") + ~CaselessKeyword("to") + ~CaselessKeyword("end_repeat") + ~CaselessKeyword("escape") + ~CaselessKeyword("const_e") + ~CaselessKeyword("with") + ~CaselessKeyword("extensible") + ~CaselessKeyword("string") + ~CaselessKeyword("unique") + ~CaselessKeyword("use") + ~CaselessKeyword("in") + ~CaselessKeyword("var") + ~CaselessKeyword("constant") + ~CaselessKeyword("total_over") + ~CaselessKeyword("end_rule") + ~CaselessKeyword("by") + ~CaselessKeyword("typeof") + ~CaselessKeyword("end_local") + ~CaselessKeyword("end_subtype_constraint") + ~CaselessKeyword("usedin") + ~CaselessKeyword("cos") + ~CaselessKeyword("div") + ~CaselessKeyword("end_if") + ~CaselessKeyword("where") + ~CaselessKeyword("entity") + ~CaselessKeyword("end_entity") + ~CaselessKeyword("unknown") + ~CaselessKeyword("end_case") + ~CaselessKeyword("end") + ~CaselessKeyword("exp") + ~CaselessKeyword("value_unique") + ~CaselessKeyword("value") + ~CaselessKeyword("true") + ~CaselessKeyword("enumeration") + ~CaselessKeyword("end_procedure") + ~CaselessKeyword("xor") + ~CaselessKeyword("length") + ~CaselessKeyword("generic_entity") + ~CaselessKeyword("from") + originalTextFor(Combine((letter + ZeroOrMore((letter | digit | CaselessLiteral("_"))))))("simple_id")
